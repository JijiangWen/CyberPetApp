...
SPOTS = [
    {
        ...
        "fish": [
            ...
            ("溪石鳜", R, 1.2, 5.5, S, 85), ("老油条鳟鱼", E, 1.8, 7.5, Mm, 95),
            ("大个体溪哥", E, 2.0, 8.0, Mm, 100), ("大水花锦鲤", E, 2.2, 9.0, S, 90),
            ("纯色金化鲤", L, 2.0, 10.0, S, 100),
            ("异变·巨型水虎鱼", M, 4.0, 18.0, S, 120, "lure_mutant_piranha"),
            ("异变·装甲溪鳗", M, 3.5, 16.0, Mm, 110, "lure_mutant_eel"),
        ],
        "preview": ["野生鲫鱼", "彩虹鳟鱼", "纯色金化鲤"],
    },
    {
        ...
        "fish": [
            ...
            ("色彩变异塘鱼", E, 1.6, 7.0, Mm, 92), ("大肚皮白鲢", E, 1.9, 8.0, S, 88),
            ("塘主·独眼老鲤", L, 2.2, 11.0, S, 100),
            ("异变·沼泽吞噬者", M, 3.8, 15.0, S, 115, "lure_swamp_devourer"),
        ],
        "preview": ["浅塘鲫", "浅塘鲤", "塘主·独眼老鲤"],
    },
    {
        ...
        "rarity": (55, 25, 14, 6),
        "fish": [
            ("近海海鲈", C, 1.0, 5.0, D, 40), ("咸水鲷鱼", C, 0.5, 3.0, D, 60),
            ("沙蚕幼体", C, 0.4, 2.0, S, 50), ("磷光小鱿", C, 0.5, 2.5, Mm, 55),
            ("近海虾群", C, 0.3, 1.5, D, 48), ("幽光幼鳗", C, 0.45, 2.2, D, 46),
            ...
            ("大型软丝鱿", E, 2.8, 13.0, D, 92), ("斑斓石斑", L, 2.0, 10.0, D, 100),
            ("异变·深海大王乌贼", M, 5.0, 22.0, D, 120, "lure_giant_squid"),
        ],
        "preview": ["夜光乌贼", "幽蓝安康", "斑斓石斑"],
    },
    {
        ...
        "fish": [
            ...
            ("风啸银鲑", R, 1.4, 7.0, Mm, 82), ("泥沼巨斑鲶", E, 2.2, 10.0, D, 95),
            ("芦湾金鳍", E, 2.0, 9.5, Mm, 90), ("湿地霸主鲤", L, 2.5, 12.0, S, 100),
            ("异变·毒沼巨鳄", M, 4.2, 17.0, Mm, 118, "lure_poison_croc"),
        ],
        "preview": ["芦苇鲈", "泥沼巨斑鲶", "湿地霸主鲤"],
    },
    {
        ...
        "fish": [
            ...
            ("彩光鲑", E, 2.0, 10.0, Mm, 100), ("盲眼洞螈", E, 2.5, 12.0, D, 95),
            ("彩鳞鳍鱼", E, 1.8, 9.5, Mm, 92), ("地下金丝鲃", L, 2.5, 12.0, Mm, 100),
            ("异变·白化巨螈", M, 4.5, 20.0, Mm, 120, "lure_albino_salamander"),
        ],
        "preview": ["引渠泥鳅", "彩光鲑", "地下金丝鲃"],
    },
    {
        ...
        "fish": [
            ...
            ("暗涌金鳞", E, 2.6, 12.5, D, 88), ("深湾老船长巨鳕", L, 3.0, 14.0, D, 100),
            ("异变·巨型魔鬼鱼", M, 4.8, 21.0, D, 120, "lure_mutant_ray"),
        ],
        "preview": ["暗涌旗鱼", "暗涌巨口鱼", "深湾老船长巨鳕"],
    },
    {
