...
src_path = r"C:\Users\wen.jijiang\.gemini\antigravity-ide\brain\5bcd1895-0ed7-458d-9f9e-ba57f8294659\icon_shop_1781253231800.png"
...
out_path = os.path.join(out_dir, "shop.png")
out_img.save(out_path)
print(f"Shop icon saved to {out_path}")
